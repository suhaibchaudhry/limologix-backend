      ...
      namespace :drivers do
        namespace :trips do
          ...
          post 'accept' do
            ...
            error!('You have exceeded the time limit to accept.' , 403) if trip.request_notifications.find_by(driver_id: current_driver).present? && ((Time.zone.now - trip.request_notifications.find_by(driver_id: current_driver).updated_at) > Trip::ACCEPTANCE_TIME)
